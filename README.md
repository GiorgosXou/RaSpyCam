# RaSpyCam - (Encrypted MySQL Comm. between IOTs)
 ...
 This is not something "important" in my opinion, it is just a "Random" thought that somehow managed to be that kind of "confusing" thing. _(Although it Started as A "Raspberry Spy Camera" = RaSpyCam)_. 🤷 For real I have no idea what should i say or not, lol look by yourself [...] ✔️ basically, i would say that it is more like something for those who want to get started with comunication through Mysql between two >= IOTs, rather than anything else [...]<br>
